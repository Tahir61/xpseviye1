...
exports.run = async(client, message, args) => {
    ...
    if (!db.fetch(`levelSystem_${message.guild.id}.status`)) return message.channel.send(new MessageEmbed().setDescription(`${client.emojis.cache.get(client.emojiler.x)} | **Hata:** Sunucuda seviye sistemi kapalı.`).setColor(message.guild.me.displayColor));
