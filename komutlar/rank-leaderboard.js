...
exports.run = async (client, message, args) => {
	...
	if (!db.fetch(`levelSystem_${message.guild.id}.status`)) return message.channel.send(new Discord.MessageEmbed().setDescription(`${client.emojis.cache.get(client.emojiler.x)} | **Hata:** Seviye sistemi kapalı.`).setColor(message.guild.me.displayColor));
